...
Создал виртуальное окружение, папка "env" добавлена в исключения "[.gitignore](https://github.com/polo7/lp-week3-homework/blob/master/.gitignore)" (в данном случае он был автоматически создан GitHub и уже содержал такое исключение).
